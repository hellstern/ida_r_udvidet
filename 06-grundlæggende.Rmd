...
* *nederst* - bliver kommandoen ikke gemt, men afvikles når du trykker *Enter*

Du skal bruge **<-** når du vil tildele en værdi til en variable eller objekt.
...
Du kan se disse objekter i vinduet øverst til højre under *Environment*
...
Uanset om du bruger kode eller GUI, så bliver hjælpen vist i det nederste højre vindue under fanen *Help*

![](image/help.png)

**GUI**
I RStudio kan du søge i det lille felt oppe i det højre hjørne af hjælpe vinduet.
Du kan søge efter funktioner eller hele pakker.


**Kode**
Du kan også få hjælpen frem via kode
