...
R bliver brugt af mere end 2 millioner mennesker og er et af verdens mest populære programmeringssprog når det gælder statistiske beregninger. 
...
Ud over selve R findes mere end 15.000 udvidelsespakker, som frit kan hentes fra *Comprehensive R Archive Network* (CRAN). Bl.a. pakker der kan indlæse data fra konkurrende produkter som SAS og SPSS.
