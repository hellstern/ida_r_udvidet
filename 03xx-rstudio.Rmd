...
Når R er installeret, kan du bruge det, men for at gøre det nemmere at skrive din R kode bruger vi et *Integreret udviklingsmiljø* (IDE), der hedder RStudio. 
...
Rstudio Desktop fåe i to forskellige versioner; Open Source Edition og RStudio Desktop Pro. 
Det er Open Source Edition jeg bruger på dette kursus: <a href="https://rstudio.com/products/rstudio/download" target="_blank">https://rstudio.com/products/rstudio/download</a>

Selve installationen er afhængig af, hvilken computer du har.

![](image/rstudio.png)

## RStudio Cloud
Du har også mulighed for at bruge cloud/onlineversionen af RStudio. Det betyder, at det ikke er nødvendigt at installere noget for at bruge RStudio.
...
Cloud løsningen giver dig de sammen muligheder/funktioner som desktop versionen og den samme brugerflade.
